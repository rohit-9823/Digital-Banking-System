    ...
    <div>
      <section class="body_content">
        <div class="container form-layout">
          ...
          <h2 class="form-title">Cheque Verify Form</h2>
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="row" style={{ marginBottom: '30px' }}>
                      <div class="col-lg-6">
                        ...
                        <Field as="select" name="branch" className={`form-control shadow-none ${errors.branch && touched.branch && 'is-invalid'}`}>
                          <option value="" style={{display:"none"}}></option>
                          {branchlist.map((values,index) => (
                            <option value={values.id} key={index}>{values.name}</option>
                          ))}
                        </Field>
